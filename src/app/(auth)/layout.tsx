...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return <main className="grid min-h-screen lg:grid-cols-[1.1fr_.9fr]">
    <section className="relative hidden overflow-hidden bg-[#0d43a5] p-16 text-white lg:flex lg:flex-col lg:justify-between">
      ...
      <p className="relative text-sm text-blue-200">Built for communities, powered by fair voting.</p>
    </section>
    <section className="flex items-center justify-center p-5"><div className="absolute right-4 top-4"><ThemeToggle /></div>{children}</section>
  </main>;
}
